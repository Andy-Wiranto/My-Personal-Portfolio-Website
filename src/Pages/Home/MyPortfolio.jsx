  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a class="btnGit" href="https://github.com/Andy-Wiranto">
            <button className="btn btn-github" href="https://github.com/Andy-Wiranto">
            <svg
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <a className="text-sm portfolio--link" href="https://github.com/Andy-Wiranto/HTML-CSS-JS-project/tree/main">
                {item.link}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
